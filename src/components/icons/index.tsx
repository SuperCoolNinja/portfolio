...
export function LogosVIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <div title="gta v mod showcase">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        className="hover:cursor-pointer hover:scale-125 transition-all"
        width="1.3rem"
      ...
      >
        ...
        >
          <path
            d="M307 12412 l-27 -28 2 -424 3 -423 110 -24 c382 -86 685 -246 872
...
export function IconParkPreviewOpen(props: SVGProps<SVGSVGElement>) {
  return (
    <div title="demo">
      <svg
        xmlns="http://www.w3.org/2000/svg"
